...
14. MCP configuration -> pretty simple we just need to have a little section where we can add MCP server configs for handing to ACP clients and test the command to be sure it runs. save in our murder.json with our agent servers in the jsonc we used to have in crow-ui-ide, the v1
...
background-size: 24px 24px;
    ...
    Your crow-ui-dark IDE background (#1e1640) would pair nicely with something like rgba(139,92,246,0.06) lines.

...
impl SelectionRange {
    ...
    pub fn all_ranges(&self) -> Vec<crow_ui_text::Range> {
...
impl SelectionRangeService {
    pub async fn provide_selection_ranges(
        client: &LspClient,
        uri: &str,
        positions: &[crow_ui_text::Position],
...
mod tests {
    ...
    fn selection_range_serde() {
        let range = SelectionRange {
            range: crow_ui_text::Range::new(
                crow_ui_text::Position::new(5, 4),
                crow_ui_text::Position::new(5, 10),
            ),
            parent: Some(Box::new(SelectionRange {
                range: crow_ui_text::Range::new(
                    crow_ui_text::Position::new(5, 0),
                    crow_ui_text::Position::new(5, 30),
                ),
                parent: None,
            })),
        };
        ...
        let range = SelectionRange {
            ...
            parent: Some(Box::new(SelectionRange {
                ...
                parent: Some(Box::new(SelectionRange {
                    range: crow_ui_text::Range::new(
                        crow_ui_text::Position::ZERO,
                        crow_ui_text::Position::new(100, 0),
                    ),
                    parent: None,
                })),
            })),
    ...
    fn selection_range_no_parent() {
        let range = SelectionRange {
            range: crow_ui_text::Range::new(
                crow_ui_text::Position::ZERO,
                crow_ui_text::Position::new(0, 10),
            ),
            parent: None,
        };

...
/// Convert a [`crow_ui_text::EditOperation`] + [`crow_ui_text::Buffer`] into a
/// tree-sitter [`InputEdit`].
///
/// The buffer should reflect the state **before** the edit was applied.
#[must_use]
pub fn to_input_edit(edit: &crow_ui_text::EditOperation, buffer: &crow_ui_text::Buffer) -> InputEdit {
...
mod tests {
    ...
    fn to_input_edit_insert() {
        let buffer = crow_ui_text::Buffer::from_str("fn main() {}");
        let edit_op = crow_ui_text::EditOperation::insert(
    ...
    fn to_input_edit_delete() {
        let buffer = crow_ui_text::Buffer::from_str("fn main() { let x = 1; }");
        let edit_op = crow_ui_text::EditOperation::delete(crow_ui_text::Range::new(
            crow_ui_text::Position::new(0, 11),
            crow_ui_text::Position::new(0, 23),
        ));
